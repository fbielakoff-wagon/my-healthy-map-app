...
# ---------------------------- PARIS — FITNESS -----------------------------
  { name: "Triomphe Fitness Club", category: "fitness", city: "Paris",
    address: "41 Rue Galilée, 75116 Paris, France",
    latitude: 48.8703206, longitude: 2.2966553,
    description: "Premium boutique gym near the Arc de Triomphe with top-tier equipment and private coaching." },
  { name: "Gym Studio Parmentier", category: "fitness", city: "Paris",
    address: "107 Ave Parmentier, 75011 Paris, France",
    latitude: 48.8674309, longitude: 2.3726925,
    description: "Friendly neighbourhood gym in the 11th with natural light and a calm training atmosphere." },
  { name: "Gymate Madeleine", category: "fitness", city: "Paris",
    address: "4 Rue de Castellane, 75008 Paris, France",
    latitude: 48.8723019, longitude: 2.3256262,
    description: "Private coaching studio near Madeleine with premium equipment for 1:1 training." },
  { name: "Kurv Studio", category: "fitness", city: "Paris",
    address: "80 Rue de Rennes, 75006 Paris, France",
    latitude: 48.8508029, longitude: 2.3300336,
    description: "Lagree/Pilates reformer studio in Saint-Germain with a coffee bar for post-workout recovery." },
  { name: "Studio Body Life", category: "fitness", city: "Paris",
    address: "19 Rue Milton, 75009 Paris, France",
    latitude: 48.878521, longitude: 2.34104,
    description: "Boutique personal-training studio offering tailored 1:1 programmes near SoPi." },
  { name: "Reformer Raum - Studio Pilates", category: "fitness", city: "Paris",
    address: "12 Rue Viollet-le-Duc, 75009 Paris, France",
    latitude: 48.881809, longitude: 2.34059,
    description: "Intimate 6-reformer Pilates studio near Pigalle with English-speaking instructors." },

  # ------------------------------ PARIS — FOOD ------------------------------
  { name: "Green Farmer's", category: "food", city: "Paris",
    address: "49 Bd de Clichy, 75009 Paris, France",
    latitude: 48.8831396, longitude: 2.334001,
    description: "Popular vegan burger spot near Moulin Rouge, known for smash burgers and sweet potato fries." },
  { name: "Wild & The Moon", category: "food", city: "Paris",
    address: "25 Rue des Gravilliers, 75003 Paris, France",
    latitude: 48.8638277, longitude: 2.3565294,
    description: "Trendy plant-based cafe with cold-pressed juices, bowls and a calm, aesthetic interior." },
  { name: "Ground To Grow", category: "food", city: "Paris",
    address: "28 Rue Chapon, 75003 Paris, France",
    latitude: 48.8637116, longitude: 2.3554073,
    description: "All-vegan restaurant with a yoga & meditation space attached in the Marais." },
  { name: "Le Potager de Charlotte", category: "food", city: "Paris",
    address: "12 Rue Louise-Émilie de la Tour d'Auvergne, 75009 Paris, France",
    latitude: 48.8789984, longitude: 2.3447152,
    description: "French-style vegan fine dining with seasonal, beautifully plated dishes." },
  { name: "Urban Greener", category: "food", city: "Paris",
    address: "30 Rue Muller, 75018 Paris, France",
    latitude: 48.8865415, longitude: 2.3454886,
    description: "Creative fully-vegan restaurant in Montmartre known for gnocchi and standout desserts." },
  { name: "Veggie Lovers", category: "food", city: "Paris",
    address: "77 Rue Saint-Martin, 75004 Paris, France",
    latitude: 48.8594939, longitude: 2.3504332,
    description: "Cozy Middle Eastern-inspired vegetarian spot near the Marais with fully vegan-adaptable dishes." },

  # ---------------------------- PARIS — WELLNESS ----------------------------
  { name: "Re-Set", category: "wellness", city: "Paris",
    address: "5 Rue Laffitte, 75009 Paris, France",
    latitude: 48.8722415, longitude: 2.3372735,
    description: "Sauna and ice-bath contrast therapy club with a beautifully designed relaxation space." },
  { name: "Octane", category: "wellness", city: "Paris",
    address: "7 Rue La Fayette, 75009 Paris, France",
    latitude: 48.8736389, longitude: 2.3347665,
    description: "Wellness-tech clinic offering hyperbaric oxygen therapy, cryo-facials and infrared sauna." },
  { name: "CryoBliss", category: "wellness", city: "Paris",
    address: "48 Rue Galilée, 75116 Paris, France",
    latitude: 48.8704512, longitude: 2.297182,
    description: "Full-body cryotherapy and pulse therapy studio popular with runners for recovery." },
  { name: "Cryotep", category: "wellness", city: "Paris",
    address: "13 Rue de la Grande Chaumière, 75006 Paris, France",
    latitude: 48.842126, longitude: 2.3305378,
    description: "Recovery clinic combining cold therapy, manual manipulation and massage in Montparnasse." },
  { name: "CRYOFAST Paris 7", category: "wellness", city: "Paris",
    address: "14 bis Av. Bosquet, 75007 Paris, France",
    latitude: 48.8596411, longitude: 2.3026999,
    description: "Cryotherapy and cryolipolysis clinic near the Eiffel Tower for recovery and toning." },
  { name: "Tuuli Spa", category: "wellness", city: "Paris",
    address: "89 Rue Lauriston, 75116 Paris, France",
    latitude: 48.867815, longitude: 2.288568,
    description: "Finnish-inspired wellness center with LED therapy, infrared and cryo-facial treatments." },
].freeze
